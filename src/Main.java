...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!connecte) {
            ...
            if (choixConnexion == 2) {
                System.out.println("Merci d'avoir utilisé DocSie... A bientôt ! Fermeture dans 3 secondes....");
                try {
                    Thread.sleep(3000);
            ...
            if (choixConnexion == 1) {
                ...
                System.out.print("URL de connexion (par défaut : jdbc:oracle:thin:@charlemagne.iutnc.univ-lorraine.fr:1521:infodb) : ");
                        ...
                        switch (choixMenu) {
                            case 1:
                                ...
                                while (continuer) {
                                    ...
                                    if (choixRecherche == 3) {
                                        continuer = false; // Quitter et retourner au menu principal
